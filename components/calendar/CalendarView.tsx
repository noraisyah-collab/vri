      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex w-56 items-center justify-center gap-2 rounded-lg bg-slate-100 px-4 py-2 text-lg font-medium text-slate-800 transition hover:bg-slate-200"
          >
            <svg
              width="18"
              height="18"
              ...
              className={year === 2027 ? "text-vri-purple" : "text-vri-blue"}
            >
